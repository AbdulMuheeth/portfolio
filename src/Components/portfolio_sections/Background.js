            ...
            <div id="viewport">
                ...
                <div className="subviewport red">
                    <div className="circles">
                        <div className="circle-top"> </div><div className="circle-top"> </div><div className="circle-top"></div><div className="circle-top"> </div>
                    </div>
                </div>

                <svg version="1.1" id="red-legs" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="239.189px" height="213.698px" viewBox="0 0 239.189 213.698"  enableBackground="new 0 0 150 150" xmlSpace="preserve" >
                <path fill="none" stroke="#333333" strokeWidth="2" d="M148.126,179.477c64-17.334,4.667-27.333,2,16">
                ...
                <path fill="none" stroke="#333333" strokeWidth="2" d="M78.559,134c64-17.334,4.667-27.333,2,16">
                <animate attributeName = "d" 
                         begin = "0s"
                         dur = "0.96s"
                         repeatCount   = "indefinite"
                ...
                <svg version="1.1" id="orange-legs" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                     width="239.189px" height="213.698px" viewBox="-30 0 239.189 213.698"  enableBackground="new 0 0 150 150" xmlSpace="preserve">
                <path fill="none" stroke="#333333" strokeWidth="2" d="M-17.904,195.477c41.333-36.127,36-59.46,45.333-80.127">
                <animate attributeName = "d" 
                         begin = "0.12s"
                         dur = "1.44s"
                         repeatCount  = "indefinite"
                ...
                <div className="subviewport blue" >
                    <div className="circles">
                        <div className="circle-top"> </div><div className="circle-top"> </div><div className="circle-top"> </div><div className="circle-top"> </div><div className="circle-top"> </div><div className="circle-top"></div><div className="circle-top"></div><div className="circle-top"> </div>
                    </div>
                </div>
